...
//共计51个工厂
public class FantasyProjectGenericCrafter {
        ...
        石英提取机 = new GenericCrafter("石英提取机") {{
            ...
            drawer = new DrawMulti(
                    ...
                    new DrawFlame(Color.valueOf("ffef99")) {{
                        flameRadius = 1.5f; //外圈大小
                        flameRadiusIn = 0.9f; //内圈大小
                        flameRadiusScl = 5; //总体收缩速度
                        flameRadiusMag = 1; //外圈扩张大小
                        flameRadiusInMag = 0.5f; //内圈扩张大小
                    }}
            );
        }};
...
// new DrawWarmupRegion(){{color = Color.valueOf("FFFFFF");}}
        ...
        铁板重型加工厂 = new GenericCrafter("重型加工厂") {{
            ...
            group = transportation;
            craftEffect = Fx.fireballsmoke;
            updateEffect = Fx.plasticExplosion;
            updateEffectChance = 0.1F;
            ambientSoundVolume = 0.2f;
        ...
        液电池制造厂 = new GenericCrafter("液电池制造厂") {{
            //localizedName = "液电池制造厂";
            
            consumeItems(with(thorium, 5,
                    空壳, 2));
            consumeLiquid(Liquids.cryofluid, 4 / 60f);
            consumePower(2.5f);
            outputItem = new ItemStack(液电池, 1);
            health = 160;
            itemCapacity = 20;
            size = 2;
            craftTime = 200;
            ...
            drawer = new DrawMulti(new DrawDefault(),
                    new DrawRegion("-rotate1") {{
                        spinSprite = true;
                        rotateSpeed = 2f;
                    }},
                    new DrawRegion("-rotate2") {{
                        spinSprite = true;
                        rotateSpeed = -2f;
                    }});
        }};
        ...
        镍板合成机 = new GenericCrafter("镍板合成机") {{
            ...
            craftEffect = mine;
            updateEffect = new Effect(20, e -> {
                color(Tmp.c1.set(C("b6ff9c")).shiftValue(0.1f));
                stroke(e.fout() + 0.2f);
        ...
        钻石离心机 = new GenericCrafter("钻石离心机") {{
            ...
            updateEffect = new Effect(50, e -> {
                color(Color.valueOf("adfaf0"));
                stroke(2f * e.fout());
                Lines.circle(e.x, e.y, 5f * e.fin());//向内圈
                color(Color.valueOf("ccfffa"));
                stroke(2f * e.fout());
            ...
            drawer = new DrawMulti(new DrawRegion("-bottom"), new DrawPlasma() {{
                plasma1 = Color.valueOf("adfaf0");
                plasma2 = Color.valueOf("6b80f6");
            }}, new DrawDefault());
        ...
        钻石混合物反应机 = new GenericCrafter("钻石混合物反应机") {{
            ...
            //craftEffect = Fx.fuelburn;
            updateEffect =  new Effect(20, e -> {
                color(Tmp.c1.set(C("4dffb9")).shiftValue(0.1f));
                stroke(e.fout() + 0.2f);
                randLenVectors(e.id, 2, e.rotation * 0.9f, (x, y) -> {
                    Lines.circle(e.x + x, e.y + y, 1f + e.fin() * 3f);
                });
        ...
        放射混合器 = new GenericCrafter("放射混合器") {{
            ...
            consumeItems(with(
                    thorium, 2, blastCompound, 1, sand, 2
            ));
            //consumeLiquid(Liquids.water, 3/60f);
        ...
        辐射混合机 = new GenericCrafter("辐射混合机") {{
            ...
            drawer = new DrawMulti(
                    ...
                    new DrawLiquidTile(辐射混合物){{drawLiquidLight = true;}},
                    new DrawDefault()
            );
        }};
...
//啸动合金后科技
        ...
        军火材料机 = new GenericCrafter("军火材料机") {{
            ...
            consumePower(480 / 60f);
            outputLiquid = new LiquidStack(军用液体, 32 / 60f);
            health = 650;
            itemCapacity = 16;
            size = 3;
            craftTime = 160;
...
////-----------
        ...
        啸动冲击械 = new GenericCrafter("啸动冲击械") {{
            ...
            drawer = new DrawMulti(
                    new DrawRegion("-bottom"),
                    new DrawLiquidTile(制冷液){{drawLiquidLight = true;}},
                    new DrawLiquidTile(啸冷剂){{drawLiquidLight = true;}},
                    new DrawDefault(),
                    new CTDrawFlame()
            );
        }};
